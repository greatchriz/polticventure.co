            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              ...
              >
                ...
                <div
                  ...
                  x-ref="popperRoot"
                  style="position: fixed; inset: auto auto 0px 0px; margin: 0px; transform: translate(76px, -12px);"
            ...
            >
              ...
              >
                        ...
                        <ul class="flex flex-1 flex-col px-4 font-inter">
                          <li x-data="accordionItem('menu-item-1')">
                            <a
                              ...
                              class="flex items-center justify-between py-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out text-slate-800 font-semibold dark:text-navy-50"
                            ...
                            >
                              ...
                              <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 text-slate-400 transition-transform ease-in-out rotate-90"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                              >
                            ...
                            >
                              ...
                              <li>
                                <a
                                  ...
                                  :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                                  class="flex items-center justify-between p-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4 font-medium text-primary dark:text-accent-light"
                                >
                                  <div class="flex items-center space-x-2">
                                    <div class="h-1.5 w-1.5 rounded-full border border-current opacity-40"></div>
                          ...
                          <li x-data="accordionItem('menu-item-2')">
                            <a
                              :class="expanded ? 'text-slate-800 font-semibold dark:text-navy-50' : 'text-slate-600 dark:text-navy-200  hover:text-slate-800  dark:hover:text-navy-50'"
                              @click="expanded = !expanded"
                              class="flex items-center justify-between py-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out text-slate-600 dark:text-navy-200 hover:text-slate-800 dark:hover:text-navy-50"
                              href="javascript:void(0);"
                            >
                              <span>User Card</span>
                              <svg
                ...
                <div
                  ...
                  style="width: 240px; height: 482px;"
                ></div>
              </div>
              <div
            ...
            <div class="-mr-1.5 flex items-center space-x-2">
              ...
              >
                ...
                <div
                  ...
                  class="popper-root"
                  x-ref="popperRoot"
                  style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-233.333px, 57.3333px);"
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        @click="activeTab = 'tabFiles'"
                        :class="activeTab === 'tabFiles' ? 'border-primary dark:border-accent text-primary dark:text-accent-light' : 'border-transparent hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100'"
                        class="btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5 border-transparent hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100"
                      >
                        Files
                      </button>
                      <button
              ...
              >
                ...
                <div
                  ...
                  class="popper-root"
                  x-ref="popperRoot"
                  style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-97.3333px, 57.3333px);"
                  data-popper-placement="bottom-end"
                >
                  <div
                    x-data="{activeTab:'tabAll'}"
          ...
          >
            ...
            >
              ...
              <div class="mt-3">
                ...
                <div
                  class="swiper mt-3 px-3 swiper-initialized swiper-horizontal"
                  x-init="$nextTick(()=>new Swiper($el,{  slidesPerView: 'auto', spaceBetween: 16}))"
                >
                  <div
                    class="swiper-wrapper"
                    style="transition-duration: 0ms;"
                    id="swiper-wrapper-b82f215f31e6e622"
                    aria-live="polite"
                  >
                    <div
                ...
                <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                  <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                    ...
                    <div class="ax-transparent-gridline">
                      ...
                      >
                        <div
                          id="apexchartsgpnkr65c"
                          class="apexcharts-canvas apexchartsgpnkr65c"
                  ...
                  <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                    ...
                    <div class="ax-transparent-gridline">
                      ...
                      >
                        <div
                          id="apexchartslb009kdp"
                          class="apexcharts-canvas apexchartslb009kdp"
                          style="width: 0px; height: 100px;"
                        ><svg
                            id="SvgjsSvg1033"
                            width="0"
            ...
            <div class="pointer-events-none absolute bottom-4 flex w-full justify-center">
              ...
              >
                <button
                  ...
                  class="btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25 text-primary dark:text-accent"
                >
                  <svg
                    x-show="activeTab === 'tabHome'"
                    xmlns="http://www.w3.org/2000/svg"
