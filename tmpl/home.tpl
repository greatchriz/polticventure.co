<!DOCTYPE html>
    ...
    <!-- Mirrored from reactheme.com/products/html/bizup/onepage1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2023 00:58:19 GMT -->
    <head>
        <!-- meta tag -->
        <meta charset="utf-8">
    ...
    <body class="defult-home">
        ...
        <div class="main-content">
            ...
            <!-- About Section Start -->
            <div id="rs-about" class="rs-about main-home bg1 pt-110 pb-110 md-pt-70 md-pb-65">
                <div class="container">
                    <div class="row y-middle">
                        ...
                        <div class="col-lg-6 pl-60 md-pl-15">
                            <div class="sec-title">
                                ...
                                <span class="sub-text">30+ years experience in business and finance consulting, IT
                                    solutions, and working with 5k+ clients over the world. </span>
            ...
            <div id="rs-services" class="rs-services main-home bg2 pt-100 pb-100 md-pt-70 md-pb-70">
                <div class="container">
                    <div class="row y-middle">
                        <div class="col-lg-7">
            ...
            <div id="rs-project" class="rs-project style1 bg3 pt-100 pb-100 md-pt-70 md-pb-70">
                <div class="container">
            ...
            <div class="rs-choose bg5 pt-100 pb-100 md-pt-70 md-pb-70">
                ...
                <!-- Services Section Start -->
                <div class="rs-services chooseus-style pt-100 md-pt-70">
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title"><a href="blog-details.html">7 Productivity tips to avoid burnout when
                                        working</a></h3>
                                <p class="desc">We denounce with righteous indige nation and dislike men who are so beguiled
                                    and demo...</p>
                                <div class="blog-btn">
            ...
            <div id="rs-contact" class="rs-contact main-home bg8 pt-100 pb-100 md-pt-70 md-pb-70">
                <div class="container">
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 md-mb-10">
                            ...
                            <ul class="address-widget">
                                ...
                                <li>
                                    <i class="flaticon-email"></i>
                                    <div class="desc">
                                        <a href="#">support@reacthemes.com</a>
                                    </div>
                                </li>
                                <li>
