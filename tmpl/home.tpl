<!DOCTYPE html>
    ...
    <!-- Mirrored from www.pinnaclegem.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2023 13:36:50 GMT -->
    ...
    <head>
            ...
            <link rel="stylesheet" href="assets/css/SGWidget.css">
            <!-- spacing css -->
    ...
    <h6 style="color:white;">We’ve helped dozens of clients raise funds, but we know that each one has a unique story to tell and specific needs and requirements. That’s why we’re more than just a source of funding.</h6>
                ...
                <div class="SGWidget" style="width:100%;height:auto;"></div>
     
     
     <script src="jswidget2.1/widget.js">
    {
    "symbols": {
    "forex": ["EURUSD","GBPUSD","AUDUSD","USDJPY","USDCAD","EURGBP","EURAUD","EURCAD","GBPAUD","GBPJPY"],
    "commodities": ["XAUUSD","XAGUSD","XAUEUR","XAGEUR"],
    "indices": ["US500","GER30","DJ30","UK100","AUS200","FRA40","EU50","HK50"],
    "stocks": ["Apple","Amazon","Facebook","Google","Netflix","Ford","Microsoft","Tesla"],
    ...
    .SGWidget .symbol,.SGWidget .spread{
        color: black;
    }
    </style>
