        ...
        <div class="col-span-12">
            <div class="card space-y-5 p-4 sm:p-5">
                <label class="block">
                    ...
                    <select
                        class="mt-1.5 w-full tomselected ts-hidden-accessible"
                    ...
                    <div class="ts-wrapper mt-1.5 w-full single">
                        <div class="ts-control"><input
                                type="select-one"
                                autocomplete="off"
                                size="1"
                                tabindex="0"
                                ...
                                aria-activedescendant="tomselect-1-opt-1"
                            ></div>
                        <div
                        ...
                        >
                            ...
                            >
                                <div
                                    class="flex space-x-3 option active"
                                    data-selectable=""
                                    data-value="1"
                                    role="option"
                                    id="tomselect-1-opt-1"
                                    aria-selected="true"
                                >
                ...
                <label class="block">
                    ...
                    <div class="ts-wrapper mt-1.5 w-full single">
                        <div class="ts-control"><input
                                ...
                                aria-activedescendant="tomselect-2-opt-4"
                            ></div>
                        <div
                            class="ts-dropdown single"
                            style="display: none; visibility: visible;"
                ...
                <label class="block">
                    ...
                    <input
                        ...
                        tabindex="-1"
                    >
                    <div class="ts-wrapper mt-1.5 w-full multi has-options">
                        <div class="ts-control"><input
                                type="text"
                                autocomplete="off"
                                size="1"
